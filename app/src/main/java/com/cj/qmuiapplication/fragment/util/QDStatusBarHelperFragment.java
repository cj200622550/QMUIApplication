...
//        QMUIGroupListView.newSection(getContext()).setDescription("支持 4.4 以上版本的 MIUI 和 Flyme，以及 5.0 以上版本的其他 Android").addItemView(mGroupListView.createItemView("沉浸式状态栏"), new View.OnClickListener() {
//                    @Override
//                    public void onClick(View v) {
